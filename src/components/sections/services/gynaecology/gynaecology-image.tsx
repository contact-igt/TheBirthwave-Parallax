...
import { gynaecologyImagery, type GynaecologyImageKey } from "@/content/gynaecology-landing-imagery";
...
/**
 * Editorial image wrapper for Gynaecology & Women's Wellness landing page.
 ...
 */
export function GynaecologyImage({
  imageKey,
  corner = "tr",
  aspect = "aspect-[4/5]",
  className,
  ...
  imageKey: Exclude<GynaecologyImageKey, "hero">;
  ...
  const image = gynaecologyImagery[imageKey] as {
    src?: string;
    alt: string;
  ...
  return (
    <div
      data-gynaecology-image={imageKey}
